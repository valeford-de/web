      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h1 className="hero-text text-gray-900 mb-12">Imprint</h1>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="mb-8">
                  ...
                  <div className="space-y-2 text-gray-600">
                    <p>
                      <strong>Company Name:</strong> Valeford UG
                      (haftungsbeschränkt)
                    </p>
                    <p>
                      <strong>Legal Form:</strong> Unternehmergesellschaft
                      (haftungsbeschränkt)
                    </p>
                    <p>
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-2 text-gray-600">
                    <p>
                      <strong>Email:</strong> hello@valeford.de
                    </p>
                    <p>
                      <strong>Website:</strong> valeford.de
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4 text-gray-600">
                    ...
                    <p>
                      ...
                      note that we are not under obligation to supervise merely
                    ...
                    <p>
                      Our offer contains links to external third parties'
                      websites. We have no influence on the contents of those
                      websites, therefore we cannot guarantee for those
                      contents. Providers or administrators of linked websites
                      are always responsible for the contents of the linked
                      websites.
                    </p>
                    ...
                    <p>
                      ...
                      copyright law shall require the prior written consent of
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-2 text-gray-600">
                    <p>
                      The use of our website is generally possible without
                      providing personal data. As far as personal data (e.g.
                      name, address or email addresses) are collected on our
                      pages, this always happens on a voluntary basis, as far as
                      possible. This data will not be passed on to third parties
                      without your express consent.
                    </p>
                    <p>
                      We point out that data transmission over the Internet
                      (e.g. communication by email) can have security gaps.
                ...
                <div className="text-sm text-gray-500 pt-8 border-t border-gray-200">
                  <p>
                    This imprint is valid as of{" "}
                    {new Date().toLocaleDateString("en-GB")} and complies with
