  ...
  const projects = [
    {
      ...
      name: "GradeTrack",
      description:
        "Modern solution for tracking academic grades and performance metrics.",
    ...
    },
    {
      ...
      name: "NutriPlan",
      description:
        "Personalized nutrition planning with AI-powered meal suggestions.",
    ...
    },
    {
      ...
      name: "FitSync",
      description:
        "Fitness tracking that syncs with all your favorite devices.",
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-3">
                  ...
                  {project.status && (
                    <span
                      className={`inline-block px-3 py-1 text-xs rounded-full ${getBadgeColor(project.status)}`}
                    >
                      {project.status}
                    </span>
                  )}
